...
const BonusButton = ({
  ...
  const TaskSvgComponent = flag ? <BonusSvg styles={{position: 'absolute',left: '-35px', minWidth: '110px', minHeight: '110px'}} /> :
   <BonusSvg styles={{position: 'absolute', left: '-29px'}} />;
  ...
  return (
    ...
    <div style = {{
      ...
      <div style={BTStyles}>Bonus cabinet</div>
      <div style={BNStyles}>8</div>
